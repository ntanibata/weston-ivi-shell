...
client_thread(void *p_ret)
{
    ...
    shellSection = weston_config_get_section(config, "shell", NULL, NULL);

    char* bitmap_BACKGROUND = NULL;
    char* bitmap_PANEL      = NULL;
    char* bitmap_BUTTON_1   = NULL;
    char* bitmap_BUTTON_2   = NULL;
    char* bitmap_BUTTON_3   = NULL;
    char* bitmap_BUTTON_4   = NULL;

    weston_config_section_get_string(shellSection,
        "background-image", &bitmap_BACKGROUND, DATADIR "/weston/background.bmp");

    weston_config_section_get_string(shellSection,
        "panel-image", &bitmap_PANEL, DATADIR "/weston/panel.bmp");

    weston_config_section_get_string(shellSection,
        "eight-image", &bitmap_BUTTON_1, DATADIR "/weston/eight.bmp");

    weston_config_section_get_string(shellSection,
        "twin-image", &bitmap_BUTTON_2, DATADIR "/weston/twin.bmp");

    weston_config_section_get_string(shellSection,
        "once-image", &bitmap_BUTTON_3, DATADIR "/weston/once.bmp");

    weston_config_section_get_string(shellSection,
        "random-image", &bitmap_BUTTON_4, DATADIR "/weston/random.bmp");
    ...
    free(bitmap_BACKGROUND);
    free(bitmap_BUTTON_1);
    free(bitmap_BUTTON_2);
    free(bitmap_BUTTON_3);
    free(bitmap_BUTTON_4);
