		     ...
		     const struct weston_shell_client *client)
{
	...
	ivi_layout_surface_add_configured_listener(layout_surface, &ivisurf->configured_listener);
...
static int move(struct shell_surface *shsurf, struct weston_seat *ws)
{
	return 0; // success
}
