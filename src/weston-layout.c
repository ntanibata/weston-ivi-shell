...
struct weston_layout ivilayout = {NULL, {0}, {0}, {0}};
...
WL_EXPORT int32_t
weston_layout_getLayersOnScreen(struct weston_layout_screen *iviscrn, uint32_t *pLength,
...
WL_EXPORT int32_t
weston_layout_getSurfacesOnLayer(struct weston_layout_layer *ivilayer, uint32_t *pLength,
                              weston_layout_surface_ptr **ppArray)
{
    struct weston_layout_surface *ivisurf = NULL;
    uint32_t length = 0;

    if (ivilayer == NULL || pLength == NULL) {
                                ...
                                void *userdata)
{
    ...
    if (ivilayer == NULL || userdata == NULL) {
